"""Canonical path resolution for kb_nano.

All filesystem paths flow through here. Every other module should
``from kb_nano.paths import ...`` instead of computing paths via
``Path(__file__)``.
