...
def test_pair_block(device="cuda", dtype=torch.bfloat16):
    ...
    from kb_nano.tasks.baseline.L2.openfold3_pair_block import PairBlock as KBPairBlock
...
def test_pairformer_block(device="cuda", dtype=torch.bfloat16):
    ...
    from kb_nano.tasks.baseline.L3.openfold3_pairformer import PairFormerBlock as KBPFBlock
