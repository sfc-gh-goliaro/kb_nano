...
run_worker = import_module("fastkernels.validate.worker").run_worker
load_real_prompt_workload = import_module(
    "fastkernels.validate.legacy_real_prompts",
).load_real_prompt_workload
_workloads = import_module("fastkernels.validate.legacy_workloads")
(
