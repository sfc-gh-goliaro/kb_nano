...
from fastkernels.validate.legacy_real_prompts import load_real_prompt_workload
from fastkernels.validate.legacy_workloads import LATENCY_WORKLOADS, THROUGHPUT_WORKLOADS
