...
from kb_nano.infra.context import get_context, get_attn_backend_config
from store_kvcache import StoreKVCache, StoreKVCacheHND
...
class Attention(nn.Module):
    ...
    def __init__(self, num_heads: int, head_size: int, scale: float,
        ...
        if self._use_trtllm:
            ...
            from flashinfer_prefill import TRTLLMPrefill
            from flashinfer_decode import TRTLLMDecode
            ...
            from flash_attn_prefill import FlashAttnPrefill
            from flash_attn_decode import FlashAttnDecode
