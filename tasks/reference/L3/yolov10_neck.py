"""YOLOv10 native neck (L3 composite).

Naive pure-torch reference for ``tasks/baseline/L3/yolov10_neck.py``:
PAN-style top-down / bottom-up feature fusion over the P3/P4/P5 backbone
maps using C2f / C2fCIB blocks, SCDown downsampling, and nearest upsampling.
"""
